    ...
    <div v-if="artifact" class="h-full overflow-y-auto p-6">
        <div class="max-w-5xl mx-auto space-y-6">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-amber-700">
                            Kamu butuh
                            <strong>{{ artifact.requiredXP }} XP</strong> untuk
                            membuka challenge ini. Saat ini:
                            <strong>{{ userStore.currentXP }} XP</strong>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                :class="{ 'opacity-40 pointer-events-none': isLocked }"
            >
                <div
