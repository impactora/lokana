...
const comments = ref([
    {
        ...
        date: "2024-01-15",
        rating: 5,
        text: "Museum yang sangat edukatif! Anak-anak sangat antusias belajar tentang sejarah batik.",
    },
    {
        id: 2,
        user: "Siti Nurhaliza",
        ...
        date: "2024-01-10",
        rating: 4,
        text: "Koleksi batik yang luar biasa lengkap.",
    },
    {
        id: 3,
        user: "Budi Santoso",
        ...
        date: "2024-01-05",
        rating: 5,
        text: "Tempat yang wajib dikunjungi bagi pecinta budaya Jawa.",
    },
]);
        ...
        <div class="max-w-5xl mx-auto space-y-6">
                ...
                <div class="absolute bottom-0 left-0 right-0 p-6 text-white">
                    <div class="flex items-center gap-2 mb-2">
                        <span
                            ...
                            :class="
                                categoryColors[museum.category] ||
                                'bg-gray-100 text-gray-700'
                            "
                        >
                            {{
                                categoryLabels[museum.category] ||
                                museum.category
                            }}
                        </span>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        >
                            ...
                            <span class="text-white/60 text-sm"
                                >({{ museum.totalReviews }} review)</span
                            >
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="lg:col-span-2 space-y-6">
                    <div
                        class="bg-white border border-gray-200 rounded-2xl p-6 space-y-6"
                    >
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            >
                                ...
                                <p class="text-sm text-amber-800">
                                    {{ museum.historyContext }}
                                </p>
                            </div>

                            <div
                                v-if="museum.museumTheme"
                        ...
                        <div
                            v-if="
                                museum.culturalValues &&
                                museum.culturalValues.length > 0
                            "
                    ...
                    >
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span
                                class="text-sm bg-white/20 px-3 py-1 rounded-full"
                            >
                        ...
                        <div
                            v-else-if="!allQuizzesAnswered && currentQuiz"
                            class="space-y-4"
                        >
                ...
                <div class="flex flex-col gap-4">
                    <div
                        class="bg-white shrink border border-gray-200 rounded-xl p-5 flex-1"
                    >
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-6">
                ...
                >
                    <div
                        ...
                        :key="artifact.id"
                        class="group flex items-center gap-3 p-3 bg-gray-50 border border-gray-200 rounded-xl hover:border-emerald-300 hover:shadow-md transition-all cursor-pointer"
                        @click="navigateTo(`/artifact/${artifact.id}`)"
                    >
                        <div
                            class="relative w-14 h-14 shrink-0 rounded-lg overflow-hidden bg-gray-100"
                        >
                            <img
                                :src="artifact.image"
                                :alt="artifact.name"
                        ...
                        <div class="flex flex-col flex-1 min-w-0">
                            <h3
                                class="font-semibold text-sm text-gray-900 leading-tight line-clamp-1"
                            >
                                {{ artifact.name }}
                            </h3>
