...
const canRedeem = (coinsRequired: number) => {
    return userStore.coins >= coinsRequired;
};

const handleRedeem = (voucherId: string, coinsRequired: number) => {
    if (!canRedeem(coinsRequired)) {
        alert(
            `Coins tidak mencukupi! Anda butuh ${coinsRequired} coins untuk menukar voucher ini.`,
        );
        return;
    }
    ...
    const confirm = window.confirm(
        `Tukar ${coinsRequired} coins dengan voucher ini?`,
    );
    if (confirm) {
        userStore.spendCoins(coinsRequired);
        userStore.redeemVoucher(voucherId);
        alert(
            "Voucher berhasil ditukar! Cek profil Anda untuk melihat voucher.",
        );
    }
};
</script>
        ...
        <div class="max-w-5xl mx-auto space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                >
                    <div class="aspect-video relative bg-gray-100">
                        ...
                        />
                        <div
                            v-if="userStore.isVoucherRedeemed(voucher.id)"
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        >
                            ...
                            <button
                                @click="handleRedeem(voucher.id, voucher.coinsRequired)"
            ...
            <div class="bg-amber-50 border border-amber-200 rounded-xl p-4">
                ...
                <ul class="text-sm text-amber-700 space-y-1">
                    ...
                    <li>4. Klik tombol "Tukar" untuk menggunakan coins</li>
